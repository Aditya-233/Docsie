...
export function OutlineSidebar({
  ...
  return (
    <aside className="w-full sm:w-64 bg-white dark:bg-[#1e1f20] border-r border-gray-200 dark:border-gray-700 flex flex-col shrink-0 select-none transition-colors fixed sm:relative inset-y-0 left-0 z-30 sm:z-auto shadow-xl sm:shadow-none">
